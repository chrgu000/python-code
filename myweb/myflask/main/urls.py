...
main.add_url_rule("/sms_table", "sms", view_func=views.all_data)
...
main.add_url_rule('/monitor/sms', "sms_send", views.send_sms, methods=['POST'])
...
main.add_url_rule('/post', "post_test", views.post_test, methods=['POST', 'GET'])
